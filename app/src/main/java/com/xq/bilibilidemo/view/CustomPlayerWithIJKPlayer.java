package com.xq.bilibilidemo.view;
...
public class CustomPlayerWithIJKPlayer extends FrameLayout {
    ...
    public CustomPlayerWithIJKPlayer(@NonNull Context context) {
        this(context, null);
    }

    public CustomPlayerWithIJKPlayer(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CustomPlayerWithIJKPlayer(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
